                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                       ...
                                       <tr>
                                          ...
                                          <td>
                                            <a href="{{ route('admin.categories.detail',['product_category' => $productCategory->id]) }}" class="btn btn-primary">Detail</a>
                                          </td>
                                          <td>
                                            <a onclick="return confirm('Are you sure')" class="btn btn-danger" href="{{ route('admin.categories.destroy', ['product_category'=>$productCategory->id]) }}">Delete</a>
                                          </td>
                                       </tr>
                                       @empty
                                        <tr>
